...
--
-- Requires the pg_cron and pg_net extensions (pg_net provides net.http_post
-- for calling out to an external HTTPS endpoint from inside Postgres).
-- Both are available on all Supabase plans, enabled per-project.
...
-- changes needed to support this second scheduler).
--
