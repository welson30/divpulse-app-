...
/**
 * Archived coming-soon gate. This used to be the public root (app/page.tsx)
 * before the real marketing site went live there — kept here, not deleted,
 * in case it's needed again. Nothing in the live app links to this route.
 *
