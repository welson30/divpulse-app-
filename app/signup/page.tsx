...
export default function SignUpPage() {
  return (
    <main className="flex flex-1 flex-col items-center justify-center gap-sp-3 px-sp-3 py-sp-8 text-center">
      ...
      <img src="/logo.svg" alt="DivPulse" className="h-14 w-14 rounded-card" width={56} height={56} />
      <h1 className="text-h1">Sign-ups open soon</h1>
      <p className="max-w-md text-body text-text-secondary">
        DivPulse is in private beta. Account creation lands here shortly — the free plan starts with 5 tracked
