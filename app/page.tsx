...
/**
 * The full marketing site — live at / since launch. Previously staged at
 * /homepage while the public root ran a coming-soon gate; that gate now
 * lives at /homepage instead (kept, not deleted, in case it's needed again).
 */
